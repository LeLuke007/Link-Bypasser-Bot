...
# bot
bot_token = os.environ.get("TOKEN", "6042642405:AAGTkTFJLvY9_0MAY6o1i8SjYqvjj0IOfHo")
api_hash = os.environ.get("HASH", "9d7718d8938e26252266f6b4e6e023d4") 
api_id = os.environ.get("ID", "19258541")
